        ...
        button.setOnClickListener(v -> {
            ...
            if(dayA != null && dayB != null){
                ...
                if(dayA.equals(selA) && dayB.equals(selB)){
                    dayA = TimeParser.parseDateDisplayDay(TimeParser.parseDate(dayA).minusDays(7));
                    dayB = TimeParser.parseDateDisplayDay(TimeParser.parseDate(dayB).minusDays(7));
                }
